import appScreenThumb from "/images/mobile-app-img-1.png";
import appScreenThumb2 from "/images/mobile-app-img-2.png";
import appScreenThumb3 from "/images/mobile-app-img-3.png";
import appScreenThumb4 from "/images/mobile-app-img-4.png";
      ...
      <div className="px-[4%] pt-10">
        <Swiper {...settings} pagination={pagination} modules={[Pagination]}>
          <SwiperSlide className="pb-[100px]">
            <div>
              <img src={appScreenThumb} draggable="false" />
            </div>
          </SwiperSlide>
          <SwiperSlide className="pb-[100px]">
            <div>
              <img src={appScreenThumb2} draggable="false" />
            </div>
          </SwiperSlide>
          <SwiperSlide className="pb-[100px]">
            <div>
              <img src={appScreenThumb3} draggable="false" />
            </div>
          </SwiperSlide>
          <SwiperSlide className="pb-[100px]">
            <div>
              <img src={appScreenThumb4} draggable="false" />
            </div>
          </SwiperSlide>
          <SwiperSlide className="pb-[100px]">
            <div>
