...
import achivementShape from "../../../public/images/banner-shape2.png";
import achivementShape2 from "../../../public/images/about-main-shape.png";
        ...
        <div className="border-t mt-11 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
          <div className="text-center border-r pt-14">
            ...
            <p className="font-Nunito text-TextColor2-0 mt-4">
              Conveniently provide access <br />
              interfaces network
            </p>
          </div>
          <div className="text-center border-r pt-14">
